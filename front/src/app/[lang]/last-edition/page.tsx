      ...
      <div className="space-y-6">
        ...
        >
          <p className="mt-12">
            ...
            compétences dans le cadre d&apos;une compétition de recherche de
            haut niveau valorisant la bienveillance entre les compétiteurs.
          </p>

          <p className="mt-12">
            Les problèmes proposés à{" "}
            <span className="bg-gradient-to-br from-sky-500 to-[#272162] inline-block text-transparent bg-clip-text">
              FMA
            </span>{" "}
            sont très stimulants et nécessitent une bonne maîtrise des bases
            mathématiques, puisqu&apos;ils sont conçus pour aider à développer
            l&apos;esprit de recherche chez les lycéens.
          </p>

          <p className="mt-6">
            Besoin de plus d&apos;idées sur le type de problèmes à{" "}
            <span className="bg-gradient-to-br from-sky-500 to-[#272162] inline-block text-transparent bg-clip-text">
              FMA
            </span>{" "}
            ? Ici tu trouveras tout pour assouvir ta curiosité !
          </p>
        </div>
        ...
        >
          <div className="space-y-4 flex flex-col md:flex-row md:space-x-4 md:space-y-0">
            <Link
              href="https://drive.google.com/file/d/1NlL0g7inbF_zO_jVfyzs--IpHzG_VLor/view?usp=drive_link"
              target="_blank"
            >
              <div className="h-[8rem] w-[9rem] py-2 bg-white border-b-4 border-b-red-500 border-2 shadow-md flex justify-center items-center rounded-md hover:cursor-pointer">
